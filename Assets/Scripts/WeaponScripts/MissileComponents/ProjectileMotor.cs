...
/// <summary>
/// General Component for moving projectiles using physics collision detection.
/// </summary>
public class ProjectileMotor : MonoBehaviour
{
    protected BulletStats bulletStats;    //from Projectile component.

    protected Collider lastHitCollider = null;
    protected List<Collider> m_PiercedTargets;

    protected string ownertag;
    protected bool m_ProjectileInteraction = false;
    ...
    public virtual void Setup(string _tag, BulletStats _mStats)
    {
        //init from stat values
        ownertag = _tag;
        bulletStats = _mStats;
    }

    public virtual void Motor(out CollisionData _collideData)
    {
    ...
    /// </summary>
    protected void BulletBounced(Collider _c)
    {
        bulletStats.riccochet--;
    ...
    /// </summary>
    protected void BulletPierced(Collider _c)
    {
    ...
    virtual protected float CalcSpeed()
    {
        ...
        float speedModified = bulletStats.speed;
